...
class OtherApplicationInformationAdmin(admin.ModelAdmin):
    ...
    list_filter = ('release', 'application', 'hardwareModel')
    search_fields = ('release__name', 'application__name', 'hardwareModel__hardwareType__name',
                     'hardwareModel__cpu__name')

class DBInformationAdmin(admin.ModelAdmin):
    list_display = ('name', 'recordSize', 'todoLogSize', 'mateLogSize', 'updateTimes')
...
class CounterCostAdmin(admin.ModelAdmin):
    ...
    list_filter = ('counterCostName', 'release', 'hardwareModel')
    search_fields = ('counterCostName__name', 'release__name', 'hardwareModel__hardwareType__name',
                     'hardwareModel__cpu__name')
